...
function template_main_below()
{
	...
	echo '
		<div id="footer">
			<div id="footerarea"  style="text-align: center; padding: 3ex;', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
			 ', theme_copyright(), ' <br /> ', $txt['c_copy'], ' <br />';
...
function theme_linktree()
{
	...
	echo '<div class="pathway_box"><span class="pathway_intro">', $txt['crip_pathway'], '</span><span class="pathway">';
	...
	foreach ($context['linktree'] as $link_num => $tree)
	{
		...
		if ($link_num != count($context['linktree']) - 1)
			...
			echo $settings['linktree_link'] && isset($tree['url']) ? '<a href="' . $tree['url'] . '" class="pathway">' . $tree['name'] . '</a>' : $tree['name'] , '<img src="'.$settings['images_url'].'/arrow.gif" style="margin: 0 4px 0 4px" alt="" />';
		else
			echo $tree['name'];
