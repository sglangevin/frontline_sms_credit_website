<?php
/**
 * @version		$Id: usergroups.php 486 2010-06-17 12:34:48Z lefteris.kavadas $
 * @package		K2
...
class K2ModelUserGroups extends JModel
{
	...
	function getData() {
		...
		$query = "SELECT userGroup.*, (SELECT COUNT(*) FROM #__k2_users WHERE `group`=userGroup.id) AS numOfUsers FROM #__k2_user_groups AS userGroup";
