...
if(!$mainframe->isAdmin() AND empty($Itemid)){
 ...
 class acajoom {
	 ...
	 function printM($type , $message) {
		...
		switch ($type) {
			case 'warning':
				$colored_message = '<img  hspace="15"  align="absmiddle" alt="warning" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/warning.png"><span style="font-size: larger; color:#F58E07; font-weight: bold;">' . $message . '</span>';
				break;
			case 'update':
				$colored_message = '<img  hspace="15" align="absmiddle" alt="upgrade" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/upgrade.gif"><span style=" font-size: larger; color:#0033FF; font-weight: bold;">' . $message . '</span>';
				break;
			case 'general':
				$colored_message = '<img  hspace="15" align="absmiddle" style="width: 28px; height: 28px;" alt="general" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/general.gif"><span style="font-size: larger; color:#5D00FF; font-weight: bold;">' . $message . '</span>';
				break;
			case 'cron':
				$colored_message = '<img  hspace="15" align="absmiddle" style="width: 28px; height: 28px;"  alt="cron" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/cron.gif"><span style="font-size: larger; color:#F58E07; font-weight: bold;">' . $message . '</span>';
				break;
			case 'suggestion':
				$colored_message = '<img  hspace="15" align="absmiddle" style="width: 28px; height: 28px;" alt="suggestion" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/status_y.png"><span style="font-size: larger; color:#00FF51; font-weight: bold;">' . $message . '</span>';
				break;
			case 'tips':
				$colored_message = '<img  hspace="15" align="absmiddle" style="width: 28px; height: 28px;" alt="tips" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/status_y.png"><span style="font-size: larger; color:#0033FF; font-weight: bold;">' . $message . '</span>';
				break;
			case 'noimage':
				$colored_message = '<span style="font-size: larger; color:#5D00FF; font-weight: bold;">' . $message . '</span>';
				break;
			case 'error':
				$colored_message = '<img  hspace="15" align="absmiddle" style="width: 28px; height: 28px;" alt="Error" src="'.ACA_JPATH_LIVE.'warning.png"><span style="font-size: larger; color:#FF0000; font-weight: bold;">' . $message . '</span>';
				break;
			case 'ok':
				$colored_message = '<img  hspace="15" align="absmiddle" alt="ok" src="'.ACA_JPATH_LIVE.'/administrator/components/com_acajoom/images/button_ok.png"><span style="font-size: larger; color: rgb(0, 153, 0); font-weight: bold;">' . $message . '</span>';
				break;
			case 'no':
   ...
   return $colored_message."\n\r";
	...
	function getStats() {
		...
		$database->setQuery( "SELECT `published` FROM `#__modules` WHERE `module` LIKE '%acajoom%' ORDER BY `published` DESC " );
...
function  miseEnHTML($title, $tip , $compoment){
	...
	function WarningIcon($warning, $title='Joomla Warning')	{
		...
		$tip 		.= '<img src="'. ACA_JPATH_LIVE .'/includes/js/ThemeOffice/warning.png" border="0"  alt="warning"/></a>';
	...
	return $exist;
	 ...
	 function checkCBPlugin() {
		...
		$xf = new xonfig();
		if(!file_exists(ACA_JPATH_ROOT . '/components/com_comprofiler/plugin/user/plug_acajoomcbplugin/acajoom_cb.php' )
			AND !file_exists(ACA_JPATH_ROOT . '/components/com_comprofiler/plugin/user/plug_acajoomcb/acajoom_cb.php')) {
     ...
     function noShow() {
        if ( @$GLOBALS[ACA.'showtag'] !='1' && file_exists( ACA_JPATH_LIVE . '/components/com_acajoom/css/acajoom.css' ) ) {
