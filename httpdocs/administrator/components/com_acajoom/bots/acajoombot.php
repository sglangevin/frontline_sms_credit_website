...
<table class="acajoomcss_bots" width="100%">
	<tr>
		<td style="vertical-align: top;">
			...
			<br /><br />
			<select name="content_id" class="inputbox" size="30" width="420px" style="width: 420px" onchange="acajoombot_content_update_output();">
			<?php
...
<?php
 ...
 function acajoombot_content_getitems() {
	 ...
	 $query = "SELECT a.id as id, a.title as title, b.title as section, c.title as category FROM #__content as a LEFT JOIN #__sections as b ON a.sectionid = b.id LEFT JOIN #__categories AS c ON a.catid = c.id WHERE a.created > '".date('Y-m-d H:i:s',time()-30240000)."' ORDER BY a.sectionid, a.catid, a.created DESC LIMIT 500";
