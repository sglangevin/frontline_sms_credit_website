...
define('_ACA_VERIFY_INFO', compa::encodeutf('Bitte überprüfen Sie den übertragenden Link, einige Informationen fehlen.'));
...
define('_ACA_SEND_UNSUBCRIBE_TIPS', compa::encodeutf('Klicken Sie auf Ja um eine Abmeldungsbestätigung zu verschicken.'));
define('_ACA_SUBSCRIBE_SUBJECT_MESS', compa::encodeutf('Bitte bestätigen Sie Ihre Anmeldung'));
...
define('_ACA_DEFAULT_UNSUBSCRIBE_MESS', compa::encodeutf('Dies ist eine Bestätigungsemail, dass Sie von der Liste entfernt worden bist. Wir bedauern, dass Sie sich entschieden haben, unsere E-Mails nicht weiter zu empfangen. Sie können sich natürlich jederzeit wieder anmelden.'));
...
define('_ACA_SEL_LIST', compa::encodeutf('Wählen Sie eine Liste'));
define('_ACA_SEL_LIST_TYPE', compa::encodeutf('- Wählen Sie eine Listenart -'));
...
define('_ACA_NO_SUSCRIBERS', compa::encodeutf('Es gibt keine Abonnenten für diese Liste'));
define('_ACA_COMFIRM_SUBSCRIPTION', compa::encodeutf('Eine Bestätigungsemail wurde Ihnen zugesand. Bitte überprüfen Sie Ihre E-Mails und klicken Sie auf den Bestätigungslink.<br />' .
		'Sie müssen Ihre E-Mailadresse bestätigen, um Ihr Abonnement gültig zu machen.'));
define('_ACA_SUCCESS_ADD_LIST', compa::encodeutf('Sie wurden erfolgreich der Liste hinzugefügt.'));


 // Subcription info
define('_ACA_CONFIRM_LINK', compa::encodeutf('Klicken Sie hier um Ihr Abonnement zu bestätigen.'));
...
define('_ACA_SUBSCRIPTION_OR', compa::encodeutf(' oder klicken Sie hier für weitere Informationen'));
...
define("_UCP_COUPON_ADD_MENU", compa::encodeutf("Coupon hinzufügen"));
...
define("_ACA_SELECT_LIST", compa::encodeutf("Bitte wählen Sie eine Liste zum editieren aus!"));
...
define("_ACA_AUTO_RESP_FREQ", compa::encodeutf("Abonnenten können Häufigkeit wählen"));
...
define("_ACA_AUTO_RESP_TIME", compa::encodeutf("Abonnenten können die Zeit auswählen"));
...
define("_ACA_SENDER_BOUNCE", compa::encodeutf("Rückantwortadresse"));
define("_ACA_LIST_DELAY", compa::encodeutf("Verzögerung"));
define("_ACA_HTML_MAILING", compa::encodeutf("HTML Mails?"));
define("_ACA_HTML_MAILING_DESC", compa::encodeutf("(wenn Sie dieses ändern, müssen Sie die Seite speichern und dann neu laden, um die Änderungen zu sehen.)"));
define("_ACA_HIDE_FROM_FRONTEND", compa::encodeutf("Im Frontend verstecken?"));
define("_ACA_SELECT_IMPORT_FILE", compa::encodeutf("Wählen Sie eine Datei zum importieren aus"));;
...
define("_ACA_MANUALLY_DELETE", compa::encodeutf("gescheitert, Sie sollten die Datei manuell löschen"));
...
//  List info box
define("_ACA_INFO_LIST_PUB", compa::encodeutf("Klicken Sie auf Ja um die Liste zu veröffentlichen"));
define("_ACA_INFO_LIST_NAME", compa::encodeutf("Tragen Sie hier den Namen Ihrer Liste ein. Sie können die Liste an Hand ihres Namen identifizieren."));
define("_ACA_INFO_LIST_DESC", compa::encodeutf("Tragen Sie hier eine kurze Beschreibung Ihrer Liste ein. Diese Beschreibung wird für Besucher Ihrer Webseite sichtbar sein."));
define("_ACA_INFO_LIST_SENDER_NAME", compa::encodeutf("Tragen Sie hier den Namen des Absenders für die Mailings ein. Dieser Name wird sichtbar sein, wenn Abonnenten Nachrichten über diese Liste empfangen."));
...
define("_ACA_INFO_LIST_SENDER_BOUNCED", compa::encodeutf("Tragen Sie hier die E-Mailadresse ein, auf die Benutzer antworten können. Es ist empfehlenswert, dass diese die gleiche wie die Senderadresse ist, da Spamfilter die Nachrichten sonst eher als Spam behandeln."));
define("_ACA_INFO_LIST_AUTORESP", compa::encodeutf("Wählen Sie den Typ für Nachrichten dieser Liste:<br />" .
...
define("_ACA_INFO_LIST_FREQUENCY", compa::encodeutf("Erlaube dem Benutzer auszuwählen, wie oft Sie Nachrichten von der Liste erhalten. Das gibt den Benutzern mehr Flexibilität."));
...
define("_ACA_INFO_LIST_DATE", compa::encodeutf("Geben Sie das Datum, an dem Sie diese Nachricht veröffentlichen wollen, wenn Sie die Veröffentlichung verzögern wollen<br /> FORMAT : YYYY-MM-DD HH:MM:SS"));
...
define("_ACA_INFO_LIST_LAYOUT", compa::encodeutf("Tragen Sie hier das Layout der Mailingliste ein. Sie können jedes Layout hier eintragen"));
define("_ACA_INFO_LIST_SUB_MESS", compa::encodeutf("Diese Nachricht wird zum Benutzer geschickt, wenn er oder sie sich registriert. Sie können jeden Text hier eintragen."));
...
define("_ACA_INFO_LIST_HTML", compa::encodeutf("Wählen Sie dieses wenn Sie eine HTML-Mail verschicken wollen. Abonnenten haben die Möglichkeit sich auszusuchen, ob sie die HTML-Nachricht empfangen wollen oder nur den reinen Text (falls sie eine HTML-Liste abonniert haben)."));
define("_ACA_INFO_LIST_HIDDEN", compa::encodeutf("Klicken Sie auf Ja um die Mailingliste vor dem Frontend zu verstecken. Dadurch können Benutzer sich nicht anmelden, aber Sie können weiterhin Mailings verschicken."));
...
define("_ACA_INFO_LIST_ACC_USER_ID", compa::encodeutf("Wählen Sie den Zugangslevel der Benutzergruppe, der Sie erlauben wollen, die Liste zu bearbeiten. Die Benutzergruppe wird in der Lage sein, Mailings zu bearbeiten und zu versenden, sowohl vom Backend, als auch vom Frontend."));
define("_ACA_INFO_LIST_FOLLOW_UP", compa::encodeutf("Wenn Sie wollen, dass der Auto-Responder zu einem weiteren wechselt, sobald es die letzte Nachricht erreicht hat, können Sie hier den folgenden Auto-Responder bestimmen."));
...
define("_ACA_LABEL_FREQ_TIPS", compa::encodeutf("Klicken Sie Ja wenn Sie dieses für einen Acajoom Cron nutzen wollen, Nein für einen anderen Cronjob.<br />" .
...
define("_ACA_CRON_SITE_URL", compa::encodeutf("Bitte tragen Sie eine gültige URL ein, beginnend mit http://"));

### Mailings ###
define("_ACA_MAILING_ALL", compa::encodeutf("Alle Mailings"));
define("_ACA_EDIT_A", compa::encodeutf("Bearbeite ein "));
define("_ACA_SELCT_MAILING", compa::encodeutf("Bitte wählen Sie eine Liste aus dem Drop-Down Menü um ein neues Mailing zu verfassen."));
...
define("_ACA_SELECT_MULTIPLE", compa::encodeutf("Halten Sie Steuerung (STRG) um mehrere Anhänge zu wählen.<br />" .
...
define("_ACA_CONTENT_ITEM_SELECT", compa::encodeutf("Wählen Sie ein Element, um es in die Nachricht einzufügen<br />Kopieren Sie den <b>Platzhalter</b> und fügen ihn in die Nachricht ein.  Sie können wählen ob Sie nur das Intro oder den gesamten Text in der Mail haben wollen (0 or 1)."));
...
define("_ACA_CHANGE_EMAIL_SUBSCRIPTION", compa::encodeutf("Ändern Sie Ihre Abonnements"));
define("_ACA_WHICH_EMAIL_TEST", compa::encodeutf("Geben Sie die E-Mailadresse an, an die eine Textmail gesendet werden soll, oder wählen Sie Vorschau"));
define("_ACA_SEND_IN_HTML", compa::encodeutf("Versende in HTML (für HTML-Mails)?"));
...
define("_ACA_SMTPAUTHREQUIRED_TIPS", compa::encodeutf("Wählen Sie ja, wenn Ihr SMTP Server Authentifizierung erfordert"));
...
define("_ACA_USE_EMBEDDED_TIPS", compa::encodeutf("Wählen Sie ja, wenn die Bilder in HTML E-Mails im Anhang eingebettet werden sollen oder nein, wenn Sie mit Standard Bilder Tags über den Server verlinkt werden sollen"));
define("_ACA_UPLOAD_PATH", compa::encodeutf("Upload/Anhang Pfad"));
define("_ACA_UPLOAD_PATH_TIPS", compa::encodeutf("Sie können ein Verzeichnis zum Hochladen bestimmen<br />" .
...
define("_ACA_ALLOW_UNREG_TIPS", compa::encodeutf("Wählen Sie JA, wenn Sie wollen, dass Benutzer sich eintragen dürfen, ohne auf der Seite registriert zu sein."));
define("_ACA_REQ_CONFIRM", compa::encodeutf("Bestätigung erfordert"));
define("_ACA_REQ_CONFIRM_TIPS", compa::encodeutf("Wählen Sie Ja, wenn Sie wollen, dass unregistrierte Benutzer Ihre E-Mailadresse bestätigen müssen."));
...
define("_ACA_CONFIRMFROMNAME_TIPS", compa::encodeutf("Tragen Sie den 'von'-Namen ein, der auf Bestätigungslisten erscheinen soll."));
define("_ACA_CONFIRMFROMEMAIL", compa::encodeutf("Bestätigung der E-mail"));
define("_ACA_CONFIRMFROMEMAIL_TIPS", compa::encodeutf("Tragen Sie die E-Mail Adresse ein, um eine Liste der Bestätigungen zu sehen."));
define("_ACA_CONFIRMBOUNCE", compa::encodeutf("Bestätigung der  Bounce E-Mail Adresse"));
define("_ACA_CONFIRMBOUNCE_TIPS", compa::encodeutf("Tragen Sie die Bounce E-Mail Adresse ein, um eine Liste der Bestätigungen zu sehen."));
define("_ACA_HTML_CONFIRM", compa::encodeutf("HTML Bestätigung"));
define("_ACA_HTML_CONFIRM_TIPS", compa::encodeutf("Wähle Ja, wenn die Bestätigungsliste HTML sein soll, sofern der Benutzer HTML erlaubt."));
define("_ACA_TIME_ZONE_ASK", compa::encodeutf("Frage nach Zeitzone"));
define("_ACA_TIME_ZONE_TIPS", compa::encodeutf("Wählen Sie Ja, wenn der Benutzer nach seiner Zeitzone gefragt werden soll. Die E-Mails werden dann auf Basis der Zeitzone versandt."));
...
define('_ACA_CRON_DESC', compa::encodeutf('<br />Wenn Sie die Cron-Funktion nutzen, können Sie eine automatische Aufgabe für Ihre Joomla Webseite einstellen!<br />' .
...
define("_ACA_PAUSEX_TIPS", compa::encodeutf("Tragen Sie eine Anzahl von Sekunden ein, die Acajoom dem SMTP Server gibt, um die E-Mails zu versenden, bevor er mit der nächsten bestimmten Anzahl von E-Mails fortfährt."));
...
define("_ACA_ENABLE_READ_STATS_TIPS", compa::encodeutf("Wählen Sie Ja, wenn gespeichert werden soll, wie viele Leute die E-Mail angesehen haben. Das kann nur bei HTML-Mails genutzt werden."));
define("_ACA_LOG_VIEWSPERSUB", compa::encodeutf("Speichere Anzeigen pro Benutzer"));
define("_ACA_LOG_VIEWSPERSUB_TIPS", compa::encodeutf("Wählen Sie Ja, wenn Anzeigen pro Benutzer gespeichert werden soll. Dies kann nur bei HTML-Mails genutzt werden."));
// Logs settings
...
define("_ACA_DISPLAY_LOG_TIPS", compa::encodeutf("Wählen Sie Ja, wenn Sie die Logs während des Mailversandes angezeigt haben möchten."));
define("_ACA_SEND_PERF_DATA", compa::encodeutf("Sendestatistik"));
define("_ACA_SEND_PERF_DATA_TIPS", compa::encodeutf("Wählen Sie Ja, wenn Sie Acajoom erlauben wöllen, anonyme Berichte über ihre Konfiguration, die Menge der Abonnmenten einer Liste und der Zeit die das Versenden der Mail zu versenden. Dies würde uns helfen, Acajoom in Zukunft zu verbessern."));
define("_ACA_SEND_AUTO_LOG", compa::encodeutf("Sende Logdatei für Auto-Responder"));
define("_ACA_SEND_AUTO_LOG_TIPS", compa::encodeutf("Wählen Sie Ja, wenn Sie wollen, dass Sie jedes Mal einen Log bekommen, wenn die Mails verschickt werden. WARNUNG: Dies kann zu einer großen Menge Mails führen"));
...
define("_ACA_SEND_LOGDETAIL_TIPS", compa::encodeutf("Detailliert beinhaltet Erfolg- oder Fehlermeldungen für jeden Abonnenten und eine Übersicht über diese Informationen. Einfach sendet nur die Übersicht."));
...
define("_ACA_SAVE_LOGDETAIL_TIPS", compa::encodeutf("Detailliert beinhaltet die Erfolgs- oder Fehlerinformation für jeden Abonnenten und eine Übersicht der Informationen. Einfach, speichert nur die Übersicht."));
define("_ACA_SAVE_LOGFILE", compa::encodeutf("Logdatei speichern"));
define("_ACA_SAVE_LOGFILE_TIPS", compa::encodeutf("Datei, an welche die Log Informationen angehängt werden. Diese Datei kann sehr groß werden."));
...
define("_ACA_AUTOS_ON_TIPS", compa::encodeutf("Wählen Sie Ja, wenn Sie Auto-Responder nicht nutzen wollen, alle Auto-Responder Optionen werden deaktiviert."));
define("_ACA_NEWS_ON", compa::encodeutf("Benutze Newsletter"));
define("_ACA_NEWS_ON_TIPS", compa::encodeutf("Wählen Sie NEIN wenn Sie keinen Newsletter nutzen möchten, alle Newsletter Optionen werden deaktiviert."));
...
define("_ACA_SHOW_LISTS_TIPS", compa::encodeutf("Wenn Benutzer nicht registriert sind, zeige eine Liste der möglichen Newsletter, die Sie abonnieren können, sowie den Archiv Button oder das Registrierungsformular."));
...
define("_ACA_UPDATE_URL_WARNING", compa::encodeutf("WARNUNG! Ändern Sie die URL nicht, es sei denn Sie würden vom technischen Team von Acajoom darum gebeten<br />"));
...
define("_ACA_USER_LEVEL_EDIT", compa::encodeutf("Wählen Sie welcher Benutzerlevel Mailings bearbeiten darf (sowohl im Frontend als auch im Backend) "));
...
// Acajoom message
define("_ACA_UPGRADE1", compa::encodeutf("Die können Benutzer und Newsletter einfach importieren aus"));
define("_ACA_UPGRADE2", compa::encodeutf(" nach Acajoom im Uprademenü."));
...
define("_ACA_CRON_SETUP", compa::encodeutf("Damit Auto-Responder verschickt werden, müssen Sie einen Cron Task einrichten."));
define("_ACA_FEATURES", compa::encodeutf('Acajoom, dein Kommunikationspartner!'));
define("_ACA_THANKYOU", compa::encodeutf('Danke, dass Sie Acajoom gewählt haben, Ihr Kommunkationspartner!'));
define("_ACA_NO_SERVER", compa::encodeutf('Der Update Server ist nicht erreichbar, probieren Sie es später noch mal.'));
...
define('_ACA_SEND_MAIL_FROM_TIPS', compa::encodeutf('Wählen Sie welche E-Mailadresse als Absender gezeigt wird.'));
define('_ACA_SEND_MAIL_NAME_TIPS', compa::encodeutf('Wählen Sie welcher Name als Absender gezeigt wird.'));
define('_ACA_MAILSENDMETHOD_TIPS', compa::encodeutf('Wählen Sie welche E-Mailfunktion Sie nutzen wollen: PHP mail function, <span>Sendmail</span> oder SMTP Server.'));
...
define('_ACA_LIST_IMPORT', compa::encodeutf('Wählen Sie die Liste(n) mit denen Abonnenten verbunden werden sollen.'));
...
define('_ACA_SHOW_LOGIN_TIPS', compa::encodeutf('Wählen Sie Ja um ein Loginformular im Frontend von Acajoom zu zeigen, so dass Benutzer sich auf der Webseite registrieren können.'));
define('_ACA_LISTS_EDITOR', compa::encodeutf('Editor der Listenbeschreibung'));
define('_ACA_LISTS_EDITOR_TIPS', compa::encodeutf('Wählen Sie Ja um einen HTMl Editor zu verwenden, um die Listenbeschreibung zu ändern.'));
...
define('_ACA_SHOW_LOGOUT_TIPS', compa::encodeutf('Wählen Sie Ja um einen Abmelde-Button im Ajacoom-Bereich auf der Webseite zu zeigen.'));
...
define('_ACA_CB_PLUGIN_TIPS', compa::encodeutf('Wählen Sie Ja um die Mailinglisten im Registrierungsformular des Community Builders zu zeigen'));
define('_ACA_CB_LISTS', compa::encodeutf('Listen IDs'));
define('_ACA_CB_LISTS_TIPS', compa::encodeutf('DIESES FELD WIRD BENÖTIGT: Tragen Sie die ID der Listen ein, die Benutzer abonnieren können sollen, getrennt durch Komma , (0 zeigt alle Listen).'));
define('_ACA_CB_INTRO', compa::encodeutf('Einführungstext'));
define('_ACA_CB_INTRO_TIPS', compa::encodeutf('Dieser Text erscheit vor der Liste. WENN ER LEER IST, WIRD NICHTS ANGEZEIGT. Benutzen Sie cb_pretext für das CSS Layout.'));
define('_ACA_CB_SHOW_NAME', compa::encodeutf('Zeige Listenname'));
define('_ACA_CB_SHOW_NAME_TIPS', compa::encodeutf('Wählen Sie ob der Listenname nach dem Einführungstext angezeigt werden soll oder nicht.'));
define('_ACA_CB_LIST_DEFAULT', compa::encodeutf('Wähle Liste Standardmässig aus'));
define('_ACA_CB_LIST_DEFAULT_TIPS', compa::encodeutf('Wählen Sie ob die Checkbox für jede Liste standardmässig aktiviert sein soll.'));
define('_ACA_CB_HTML_SHOW', compa::encodeutf('Zeige HTML empfangen'));
define('_ACA_CB_HTML_SHOW_TIPS', compa::encodeutf('Setzten Sie dieses auf JA um Benutzern zu erlauben auszuwählen, ob sie HTML E-Mails bekommen wollen oder nicht. Setzen Sie auf Nein um Standardeinstellungen zu verwenden.'));
define('_ACA_CB_HTML_DEFAULT', compa::encodeutf('Standardmässig HTML empfangen'));
...
define('_ACA_SHOW_ARCHIVE_TIPS', compa::encodeutf('Wählen Sie JA um den Archiv Knopf in der Newsletter Liste im Frontend anzuzeigen'));
...
define('_ACA_INPUT_EMAIL_TIPS', compa::encodeutf('Geben Sie Ihre e-mail Adresse ein (Stellen Sie sicher das dies eine gültige e-mail Addresse ist, wenn Sie unsere Mailings empfangen möchten.)'));
define('_ACA_RECEIVE_HTML_TIPS', compa::encodeutf('Wählen Sie Ja wenn Sie HTML Mailings empfangen möchten - Nein um reine Text Mailings zu empfangen'));
define('_ACA_TIME_ZONE_ASK_TIPS', compa::encodeutf('Wählen Sie Ihre Zeitzone.'));
...
define('_ACA_TOO_LARGE', compa::encodeutf('Die Datei ist zu groß. Die maximal erlaubte Größe beträgt'));
...
define('_ACA_NO_WRITE_PERMS', compa::encodeutf('Sie haben keine Schreibberechtigung für das Zielverzeichnis.'));
define('_ACA_NO_USER_FILE', compa::encodeutf('Sie haben keine Datei zum hochladen ausgewählt.'));
...
define('_ACA_CANNOT_OVERWRITE', compa::encodeutf('Die Datei existiert bereits und kann nicht überschrieben werden.'));
...
define('_ACA_USE_SEF_TIPS', compa::encodeutf('Es wird empfohlen NEIN zu wählen. Wenn Sie möchten das diese URL in Ihre Mailings eingefügt wird um SEF zu benutzen dann wählen Sie JA.' .
...
define('_ACA_ERR_SEND_TIPS', compa::encodeutf('Wenn Sie möchten das Acajoom stetig verbessert wird wählen Sie JA. Dadurch wird ein Fehlerbericht zu uns gesendet.  Somit brauchen Sie uns keinen manuellen Fehlerbericht mehr zu senden <br /> <b>ES WERDEN KEINE PRIVATEN INFORMATIONEN GESENDET</b>.  Wir erfahren noch nichteinmal von welcher Webseite der Fehlerbericht kommt. Wir versenden ausschließlich Informationen über Acajoom , das PHP Setup und SQL abfragen. '));
define('_ACA_ERR_SHOW_TIPS', compa::encodeutf('Wählen Sie JA um die Fehlernummer anzuzeigen.  Wird zu debugging Zwecken genutzt. '));
define('_ACA_ERR_SHOW', compa::encodeutf('Fehler anzeigen'));
define('_ACA_LIST_SHOW_UNSUBCRIBE', compa::encodeutf('Zeige Kündigungs Links'));
define('_ACA_LIST_SHOW_UNSUBCRIBE_TIPS', compa::encodeutf('Wählen Sie Ja um die Kündigungs Links am Ende der Mailings damit die Empfänger ihr Abonnement ändern können.<br /> Nein,um Fusszeilen und Links zu deaktivieren.'));
define('_ACA_UPDATE_INSTALL', compa::encodeutf('<span style="color: rgb(255, 0, 0);">WICHTIGE MITTEILUNG!</span> <br />Wenn Sie von einer älteren Acajoom Installation wechseln wollen, müssen Sie Ihre Datenbankstruktur aktualisieren, indem Sie folgenden Knopf klicken (Ihre Daten bleiben dabei erhalten)'));
...
define('_ACA_MAILING_MAX_TIME_TIPS', compa::encodeutf('Geben Sie die maximale Zeit für jedes E-Mail Paket das von der Warteschlange gesendet wird ein. Empfohlene Werte liegen zwischen 30 Sek. and 2 Min.'));
...
define('_ACA_VM_COUPON_NOTIF_TIPS', compa::encodeutf('Geben Sie die ID Nummer des Mailings an welches Sie benutzen möchten um die Coupons zu Ihren Kunden zu schicken.'));
...
define('_ACA_FORM_LIST_TIPS', compa::encodeutf('Wählen Sie die Liste aus die Sie in Ihr Formular einfügen möchten'));
// update messages
...
define('_ACA_CHECK', compa::encodeutf('Überprüfen'));
...
define('_ACA_DOWNDATE', compa::encodeutf('Zurück zur letzten Version'));
define('_ACA_DOWNGRADE', compa::encodeutf('Zurück zum Basis Produkt'));
define('_ACA_REQUIRE_JOOM', compa::encodeutf('Benötige Joomla'));
define('_ACA_TRY_IT', compa::encodeutf('Ausprobieren!'));
define('_ACA_NEWER', compa::encodeutf('Neuer'));
define('_ACA_OLDER', compa::encodeutf('Älter'));
...
define('_ACA_INTRO_ONLY_TIPS', compa::encodeutf('Wenn Sie diese Option auswählen, wird nur der Einführungstext des Artikels in Ihr Mailing eingesetzt. Dazu ein Link zu dem kompletten Artikel auf Ihrer Seite.'));
define('_ACA_TAGS_TITLE', compa::encodeutf('Inhalts Variable'));
define('_ACA_TAGS_TITLE_TIPS', compa::encodeutf('Kopieren und fügen Sie diese Variable in Ihr Mailing, an der Stelle an der der Inhalt erscheinen soll.'));
...
define('_ACA_AUTO_UPDATE_TIPS', compa::encodeutf('Wählen Sie JA wenn Sie über neue Updates der Komponente benachrichtigt werden wollen. <br />Wichtig!! "Tips anzeigen" muss eingeschaltet sein damit diese Funktion arbeitet.'));
