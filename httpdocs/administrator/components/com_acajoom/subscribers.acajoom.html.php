...
class subscribersHTML {
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="4" class="adminlist">
		<tr>
			<th class="title">#</th>
			<th class="title"><input type="checkbox" id="selectallcheck" name="allchecked" onclick="acajoomselectall();"/></th>
	...
	<?php	} ?>
		...
		?>
				<tr class="row<?php echo ($i + 1) % 2;?>">
					...
					<td>
						<input type="checkbox" id="cid[<?php echo $i; ?>]" name="cid[<?php echo $i; ?>]" value="<?php echo $subscriber->id; ?>" onclick="isChecked(this.checked);" />
					</td>
					<td>
