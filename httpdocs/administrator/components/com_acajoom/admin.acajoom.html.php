...
<?php
	...
	function _footer() {
	 ...
	 function _footerSignature() {
		...
		echo '<br /><div align="center" class="footer"><span class="footer">'. acajoom::version() .
...
<?php					 //<th style="text-align: center;"> echo _ACA_DESC_SUBSCRIBERS; </th> ?>
				</tr>
			 <?php
			$html = '';
			$totalist = 0;
...
?>
		...
		<?php
 if ( ACA_CMSTYPE ) {
		 echo acajoom::printM('blue', _ACA_SERVER_LOCAL_TIME.' :'. JHTML::_('date', acajoom::getNow(), '%A, %d %B %Y %H:%M', 0));
 } else {
...
<?php
	 ...
	 function iconsPanel() {
		...
		$link = "http://www.ijoobi.com/index.php?option=com_agora&Itemid=60";
		backHTML::quickiconButton( $link, 'support.png', _ACA_MENU_HELP, true, 'Registered' );

		$link = 'http://www.ijoobi.com/index.php?option=com_content&view=category&layout=blog&id=29&Itemid=72';
	...
	function about(){
		...
		acajoom::miseEnPage('Hebrew', '', 'Eszter Somos & Adam Segev');
		...
		acajoom::miseEnPage(' ', '', '   ');
		acajoom::miseEnPage(_ACA_DESC_HOME, '', '<a href="'.$GLOBALS[ACA.'homesite'].'" target="_blank">www.ijoobi.com</a>');
		acajoom::miseEnPage(_ACA_MENU_HELP, '', '<a href="http://www.ijoobi.com/index.php?option=com_content&Itemid=72&view=category&layout=blog&id=29&limit=60" target="_blank">Documentation</a>');
		acajoom::miseEnPage(_ACA_MENU_HELP, '', '<a href="http://www.ijoobi.com/index.php?option=com_agora&Itemid=60" target="_blank">Forum</a>');
...
### http://www.ijoobi.com/index.php?option=com_content&view=article&id=12&Itemid=54
### http://www.ijoobi.com/index.php?option=com_content&view=article&id=12&Itemid=54
		acajoom::miseEnPage( _ACA_LICENSE , '', '<a href="http://www.ijoobi.com/index.php?option=com_content&view=article&id=12&Itemid=54" target="_blank">&copy; Acajoom Services</a>');
		acajoom::endOfTable();
		backHTML::formEnd();
		echo '</td>';
		echo '<td width="380px">';
		$logo = 'acajoom_slog_'. strtolower($GLOBALS[ACA.'type']).'.png';
		echo '<a href="http://www.ijoobi.com" target="_blank"><img src="components/com_acajoom/images/'.$logo.'" alt="Acajoom Logo" border="0" align="center" /></a>';
		echo '</td>';
		echo '</tr></table>';
	...
	function installPlus(){
		...
		<div>
		<form action="http://www.ijoobi.com/index.php?option=com_acajoom" method="post" name="modacajoomForm">
