	...
	*/
	...
	function createDialog() {
		...
		setStyle(elements.dialog, {
			...
			'background' : "url('"+dir+"images/color_picker/hv"+HVSize[0]+'x'+HVSize[1]+".png') "+padding+"px "+padding+"px no-repeat ThreeDFace"
		})
		...
		setStyle(elements.hv, {
			...
			'height' : HVSize[1]+2*padding+'px',
			'background' : "url('"+dir+"images/color_picker/cross.gif') no-repeat",
			'cursor' : 'crosshair'
		})
		...
		setStyle(elements.s, {
			...
			'height' : HVSize[1]+2*padding+'px',
			'background' : "url('"+dir+"images/color_picker/s.gif') no-repeat"
		})
		// IE 5 fix
		try {
...
function update1() {
	var color = document.getElementById('blog-title-color').value
	document.getElementById('blog-title-color').style.backgroundColor = '#'+color
}
function update2() {
	var color = document.getElementById('blog-subtitle-color').value
	document.getElementById('blog-subtitle-color').style.color = '#'+color
}